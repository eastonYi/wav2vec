...
gpu=$1
SAVE_DIR=exp/finetune_6lang_sentencepiece
W2V_PATH=exp/pretrain_6lang/checkpoint_best.pt
DATA_DIR=data/finetune_6lang_sentencepiece
...
--train-subset train_6lang --valid-subset valid_6lang --no-epoch-checkpoints --best-checkpoint-metric uer \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 7000 --validate-after-updates 2000  --validate-interval 5 \
...
--log-interval 50 --log-format simple --save-interval 5
