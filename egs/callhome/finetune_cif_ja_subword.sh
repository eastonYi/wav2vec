...
gpu=$1
SAVE_DIR=exp/finetune_cif_ja_char
...
--feature-grad-mult 0.0 --freeze-finetune-updates 3000 --validate-after-updates 3000  --validate-interval 1 \
