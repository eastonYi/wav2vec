...
--num-workers 2 --max-update 80000 --sentence-avg --task audio_pretraining --arch wav2vec_seq2seq --w2v-path $W2V_PATH \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 3000 --validate-after-updates 10000  --validate-interval 20 \
...
--final-dropout 0.0 --dropout 0.0 --activation-dropout 0.1 --criterion cross_entropy \
