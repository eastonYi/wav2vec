...
gpu=$1
SAVE_DIR=exp/finetune_ctc_seq2seq_acc
...
--num-workers 2 --max-update 80000 --task audio_pretraining --arch wav2vec_ctc_seq2seq --w2v-path $W2V_PATH \
...
--final-dropout 0.0 --dropout 0.0 --activation-dropout 0.1 --criterion ctc_ce \
