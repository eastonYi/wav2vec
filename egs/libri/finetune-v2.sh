...
MODEL_PATH=../libri/exp/base_finetune/checkpoint_best.pt

. path.sh

CUDA_VISIBLE_DEVICES=0,1,2,3 python $SRC_ROOT/train.py $DATA_DIR --save-dir $SAVE_DIR \
...
--attention-dropout 0.0 --max-tokens 1280000 --fix-batches-to-gpus --seed 2337 --log-format json --ddp-backend no_c10d --update-freq 3 \
