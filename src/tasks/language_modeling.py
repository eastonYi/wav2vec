...
from dataload.shorten_dataset import maybe_shorten_dataset
...
class LanguageModelingTask(FairseqTask):
    ...
    Args:
        dictionary (~dataload.Dictionary): the dictionary for the input of
            the language model
        output_dictionary (~dataload.Dictionary): the dictionary for the
