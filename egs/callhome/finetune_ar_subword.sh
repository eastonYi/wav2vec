...
gpu=$1
SAVE_DIR=exp/finetune_ar_subword
...
--num-workers 2 --max-update 80000 --sentence-avg --task audio_pretraining --arch wav2vec_ctc --w2v-path $W2V_PATH \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 2000 --validate-after-updates 10000  --validate-interval 20 \
