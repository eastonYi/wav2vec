...
gpu=$1
SAVE_DIR=exp/finetune_ctc_ge_subword
...
--task audio_pretraining --arch wav2vec_ctc --w2v-path $W2V_PATH --labels $label_type --sentence-avg \
...
--feature-grad-mult 0.0 --freeze-finetune-updates 1 --validate-after-updates 3000  --validate-interval 20 \
...
--final-dropout 0.0 --dropout 0.0 --activation-dropout 0.1 --criterion ctc --zero-infinity \
